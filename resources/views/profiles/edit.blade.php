...
<div class="container">
    <form action="/profile/{{ $user->id }}" enctype="multipart/form-data" method="POST">
        ...
        <!-- to make form authenticate that it came from server -->
        @csrf
        <!-- to make this form to update the profile -->
        @method('PATCH')
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="row">
                    ...
                    @error('image')
                    <strong style="margin-top: 0.25rem; font-size: 80%; color: #e3342f;">{{ $message }}</strong>
                    @enderror
                </div>
